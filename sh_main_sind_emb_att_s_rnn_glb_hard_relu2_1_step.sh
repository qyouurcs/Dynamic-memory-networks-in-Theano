...
THEANO_FLAGS="floatX=float32,device=gpu$gpuid" python main_sind_emb_att_s_rnn_glb_hard_relu2_1_step.py --save_dir states_emb_att_s_rnn_glb_hard_relu2_1_step --learning_rate 0.1 --batch_size 15
