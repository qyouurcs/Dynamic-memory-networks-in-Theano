...
parser.add_argument('--batch_size', type=int, default=2, help='no commment')
...
if args.network == 'dmn_batch_sind':
    import dmn_batch_sind_emb_visual_global
    dmn = dmn_batch_sind_emb_visual_global.DMN_batch(**args_dict)
