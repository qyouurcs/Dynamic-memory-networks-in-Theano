...
THEANO_FLAGS="floatX=float32,device=gpu$gpuid" python main_sind_emb_rnn_glob_story_no_att.py --save_dir states_emb_rnn_glob_story_no_att --learning_rate 0.1
