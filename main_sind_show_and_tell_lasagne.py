...
parser.add_argument('--batch_size', type=int, default=200, help='no commment')
parser.add_argument('--data_dir', type=str, default="data/sind", help='data root directory')
parser.add_argument('--save_dir', type=str, default="states_show_tell_lasagne", help='data root directory')
...
parser.add_argument('--SEQUENCE_LENGTH', type=int, default=41, help='flag for enabling softmax on attention vector')
...
if args.network == 'dmn_batch_sind':
    import show_and_tell_sind_lasagne
    dmn = show_and_tell_sind_lasagne.DMN_batch(**args_dict)
...
def do_epoch(mode, epoch, skipped=0):
    ...
    for i in range(0, batches_per_epoch):
        ...
        current_norm = step_data["current_norm"]
