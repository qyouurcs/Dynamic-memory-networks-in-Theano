...
parser.add_argument('--save_dir', type=str, default="states_rnn_show_global", help='data root directory')
...
args_dict['word_vector_size'] = 300
    

# init class
if args.network == 'dmn_batch_sind':
    import dmn_batch_sind_emb_rnn_global
    dmn = dmn_batch_sind_emb_rnn_global.DMN_batch(**args_dict)
