...
class DMN_batch:
    ...
    def __init__(self, data_dir, word2vec, word_vector_size, dim, cnn_dim, story_len,
        ...
        init_ans = T.concatenate([self.q_q, q_glb_rhp.dimshuffle(1,0)], axis = 0)
        ...
        last_mem = last_mem.dimshuffle('x', 0, 1)
        last_mem_step = T.repeat(last_mem, answer_inp.shape[0], 0)

        answer_inp = T.concatenate([answer_inp, last_mem_step], axis = 1)
