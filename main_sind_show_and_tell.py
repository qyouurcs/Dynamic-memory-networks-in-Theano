...
parser.add_argument('--save_dir', type=str, default="states_show_tell", help='data root directory')
...
if args.network == 'dmn_batch_sind':
    import show_and_tell_sind_emb
    dmn = show_and_tell_sind_emb.DMN_batch(**args_dict)
