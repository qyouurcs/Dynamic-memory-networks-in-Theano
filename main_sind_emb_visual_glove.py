...
word2vec = utils.load_glove_vocab(args.glove_vocab_fn)
...
if args.network == 'dmn_batch_sind':
    import dmn_batch_sind_emb_visual_glove
    dmn = dmn_batch_sind_emb_visual_glove.DMN_batch(**args_dict)
...
if args.mode == 'train':
    ...
    for epoch in range(args.epochs):
        ...
        state_name = 'states_emb_visual/%s.epoch%d.test%.5f.state' % (network_name, epoch, epoch_loss)
